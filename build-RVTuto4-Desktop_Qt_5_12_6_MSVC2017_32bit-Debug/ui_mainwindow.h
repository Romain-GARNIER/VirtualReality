...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        image->setMinimumSize(QSize(1, 0));
        image->setMaximumSize(QSize(130, 100));
        image->setPixmap(QPixmap(QString::fromUtf8(":/textures/wood.png")));
        image->setScaledContents(true);

        verticalLayout->addWidget(image);

        takePicucture = new QPushButton(centralwidget);
        takePicucture->setObjectName(QString::fromUtf8("takePicucture"));

        verticalLayout->addWidget(takePicucture);
        ...
        QObject::connect(takePicucture, SIGNAL(clicked()), MainWindow, SLOT(takePicture()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        takePicucture->setText(QApplication::translate("MainWindow", "Take a picture", nullptr));
    } // retranslateUi
