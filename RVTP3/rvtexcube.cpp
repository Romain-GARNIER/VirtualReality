...
void RVTexCube::initializeBuffer()
{
    ...
    //Vecteurs textures
    QVector3D SW1(0, 0.5, 0); QVector3D SE1(0.25, 0.5, 0); QVector3D NE1(0.25, 0.75, 0); QVector3D NW1(0, 0.75, 0);
    QVector3D SW2(0.75, 0.5, 0); QVector3D SE2(1, 0.5, 0); QVector3D NE2(1, 0.75, 0); QVector3D NW2(0.75, 0.75, 0);
    QVector3D SW3(0, 0, 0); QVector3D SE3(0.25, 0, 0); QVector3D NE3(0.25, 0.25, 0); QVector3D NW3(0, 0.25, 0);
    QVector3D SW4(0, 0.5, 0); QVector3D SE4(0.25, 0.5, 0); QVector3D NE4(0.25, 0.75, 0); QVector3D NW4(0, 0.75, 0);
    QVector3D SW5(0.25, 0.5, 0); QVector3D SE5(0.5, 0.5, 0); QVector3D NE5(0.5, 0.75, 0); QVector3D NW5(0.25, 0.75, 0);
    QVector3D SW6(0.5, 0.5, 0); QVector3D SE6(0.75, 0.5, 0); QVector3D NE6(0.75, 0.75, 0); QVector3D NW6(0.5, 0.75, 0);
